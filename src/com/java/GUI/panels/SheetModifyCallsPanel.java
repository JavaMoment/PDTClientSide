...
public class SheetModifyCallsPanel extends JPanel {
	...
	private List<Estudiante> eliminados;
	...
	public SheetModifyCallsPanel(Evento evento) {
		...
		btnSelect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					EstudianteEvento estudianteSeleccionado = estudianteEvento.get(rowIndex);
					if(!eliminados.contains(estudianteSeleccionado)) {
						
					}
					TableModel listModel2 = new EntityTableModel<>(estudiantesColNames, eliminados);
